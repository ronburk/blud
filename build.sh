...
zip -FS blud.zip *.c *.lua *.cpp *.h *.org builtin.blud build.sh gpatch.sh chatgpt_patch.sh chatgpt_patch_start.sh chatgpt_patch_finish.sh CHATGPT_NOTES.md CHATGPT_PREFLIGHT.sh CLOBBER.sh test.blud test/* bludfile .gitignore "${LUAJIT_FILES[@]}" -x bludlua.c
