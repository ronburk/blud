...
./cstr runtime.lua dircache.lua shell.lua util.lua macro.lua error.lua main.lua init.lua blud.lua builtin.blud debugger.lua implicit.lua compiler.lua compile_io.lua operator.lua scope.lua atom.lua why.lua >./bludlua.c
